% Optimize sk and T
function [coeffs_s, delta_t, T] = optim_jmt(sk,sk_dot,sk_double_dot,sT_dot, sT_double_dot, fast_option)
...
if ~fast_option
    ...
    [coeffs_s , sT] = jmt_fast(sk,sk_dot,sk_double_dot,sT_dot, sT_double_dot,T);
