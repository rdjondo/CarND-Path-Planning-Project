...
mapCoordToVehicleCoordinates (double car_x, double car_y, double yaw,
                              double x_way, double y_way)
{
...
inline vector<double>
mapPtVehCoordToMapCoordinates (double car_x, double car_y, double yaw,
                               double x_way, double y_way)
{
                  ...
                  if (event == "telemetry")
                    {
                      ...
                      vector< double> start =
                        { sk, sk_dot, sk_double_dot, sk_triple_dot};
                      vector <double> end =
